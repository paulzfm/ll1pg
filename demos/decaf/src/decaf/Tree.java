...
public abstract class Tree {
	...
	/**
	 * Tertiary operator, of type Tertiary.
	 */
	public static final int TERTIARY = STRING + 1;
	...
	public static class Assign extends Tree {
		...
		public Expr left; // NOTE: change `LValue` as `Expr` to match the modified syntax.
		public Expr expr;
	...
	/**
	 * A calculate statement (like i++, --j).
	 */
